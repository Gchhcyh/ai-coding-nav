      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/?category=ai-ide" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
              AI IDE
            </Link>
            <Link href="/?category=agent-framework" className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
              Agent框架
            </Link>
